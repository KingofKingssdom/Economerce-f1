        ...
        <>
            <div className="category">
                <Link to="/phoneProduct" className="item-category">
                    <IoIosPhonePortrait className="icon-item-category icon-item-category-left" />
                    <li className="item-li">Điện thoại</li>
                    <IoIosArrowForward className="icon-item-category icon-item-category-right" />
                </Link>
                <Link to="/tabletProduct" className="item-category">
                    <FaTabletAlt className="icon-item-category icon-item-category-left" />
                    <li className="item-li">Tablet</li>
                    <IoIosArrowForward className="icon-item-category icon-item-category-right" />
                </Link>
                <Link to="/laptopProduct" className="item-category">
                    <FaLaptop className="icon-item-category icon-item-category-left" />
                    <li className="item-li">Laptop</li>
                    <IoIosArrowForward className="icon-item-category icon-item-category-right" />
                </Link>
                <Link to="/soundProduct" className="item-category">
                    <TbDeviceAirpods className="icon-item-category icon-item-category-left" />
                    <li className="item-li">Âm thanh</li>
                    <IoIosArrowForward className="icon-item-category icon-item-category-right" />
                </Link>
                <Link to="/watchProduct" className="item-category">
                    <IoWatchOutline className="icon-item-category icon-item-category-left" />
                    <li className="item-li">Đồng hồ</li>
                    <IoIosArrowForward className="icon-item-category icon-item-category-right" />
                </Link>
                <Link to="/screenProduct" className="item-category" >
                    <HiMiniComputerDesktop className="icon-item-category icon-item-category-left" />
                    <li className="item-li">Màn hình</li>
                    <IoIosArrowForward className="icon-item-category icon-item-category-right" />
                </Link>
                <Link to="/tiviProduct" className="item-category">
                    <MdScreenshotMonitor className="icon-item-category icon-item-category-left" />
